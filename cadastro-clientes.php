...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO `clientes` ( `nome`, `email`, `telefone`,`endereco`,`data_nascimento`) VALUES ( :nome, :email, :telefone, :endereco, :data_nascimento);"; 
...
if ($stmt->execute()) {
   ...
   header("location: edita-cliente.php?id=$lastId&msg=sucesso");
   exit;
}
else {
    $msg = "Erro ao cadastra o clientes!";
}
}
                                    ...
                                    <!--campo telefone-->
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <input type="text" id="endereco" name="endereco" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira o endereco do cliente
                                        </div>
                                    </div>
