...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE produtos SET nome = :nome, categoria = :categoria, preco = :preco, marca = :marca, tamanho = :tamanho, descricao = :descricao, cor = :cor WHERE id = :id";
...
if ($stmt->execute()) {
    ...
    $msg = "Erro ao attualizar o produto!";
}
}
                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title">EDITA PRTODUTO :: <?php echo $produto["id"]." | ".$produto["nome"];?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
