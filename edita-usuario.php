...
if ($stmt->execute()) {
    ...
    $msg = "Erro ao attualizar o usuario!";
}
}
                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title">EDITA USUARIO :: <?php echo $user["id"]." | ".$user["nome"];?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                            <form action="edita-usuario.php?id=<?php echo $user['id']?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" id="senha" name="senha" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira a SENHA do ususario.
                                        </div>
                                    </div>
                                    <!--campo email-->
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="email" name="email" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira o email do ususario.
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Salvar</button>
                                         <!-- Botão Excluir -->
                                        <a href="exclui-usuario.php?id=<?php echo htmlspecialchars($user['id']); ?>" 
