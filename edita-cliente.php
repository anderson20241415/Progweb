...
if ($stmt->execute()) {
    ...
    $msg = "Erro ao attualizar o cliente!";
}
}
                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title">EDITA CLIENTE :: <?php echo $user["id"]." | ".$user["nome"];?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                            <form action="edita-cliente.php?id=<?php echo $user['id']?>" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="mb-3">
                                        ...
                                        <input type="date" id="data_nascimento" name="data_nascimento" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira a data de nascimento do cliente.
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Salvar</button>
                                         <!-- Botão Excluir -->
                                        <a href="exclui-cliente.php?id=<?php echo htmlspecialchars($user['id']); ?>" 
