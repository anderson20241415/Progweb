    ...
    $qtd_prod = count($listaProdutos);
                        ...
                        for($i=0;$i<$qtd_prod;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            ...
                                            <a href=\"exclui-produto.php?id=".$listaProdutos[$i]["id"]."\"class=\"btn btn-danger btn-sm\" title=\"excluir\" onclick=\"return confirm('TEM CERTEZA DE QUE DESEJA EXCLUIR ESTE PRODUTO?');\">
